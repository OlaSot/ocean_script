...
export function Hero() {
  return (
<section className="relative h-screen flex flex-col justify-center overflow-hidden rounded-b-[40px]">
  <div
    className="absolute inset-0 z-0 bg-no-repeat bg-cover bg-center overflow-hidden"
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center mt-[120px] ">
    ...
    <motion.h1
      className="text-5xl leading-[60px] md:text-7xl md:leading-[100px] font-extrabold my-[22px]"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8 }}
    >
