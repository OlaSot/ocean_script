...
export default function ContactShortForm() {
  const inputClasses =
  ...
  return (
    <section className="relative py-20 bg-[url('/contacts2.webp')] bg-fixed bg-cover overflow-hidden rounded-[40px] mb-[100px] text-white">
      <Container>
        <div className="absolute top-[-80px] left-10 w-60 h-60 pointer-events-none select-none">
          <Image
            src="/figures/Untitled-1-01.png"
              ...
              <form className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    className="w-full h-[180px] bg-transparent border border-white rounded-[20px] px-[30px] py-[17px] text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-btn_color focus:border-transparent transition-shadow appearance-none"
                  />
                </div>
