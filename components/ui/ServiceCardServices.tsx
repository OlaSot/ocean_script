...
export function ServiceCardServices({ title, description, index, image }: ServiceCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-[24px] sm:text-[28px] font-bold text-black">{title}</h3>
        </div>
        <p className="text-[16px] sm:text-[18px] mb-4 text-black">{description}</p>
      </div>
