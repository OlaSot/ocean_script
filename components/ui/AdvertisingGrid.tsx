    ...
    <div className={gridClass}>
      {items.map((item, index) => (
        <motion.div
          ...
          className={`relative p-6 rounded-[30px] shadow-lg overflow-hidden flex flex-col justify-end ${minHeightClass}
        ...
        >
          ...
          <div>
            {item.subtitle && (
              <span className="absolute top-10 left-4 text-sm font-medium uppercase text-btn_color">
                {item.subtitle}
              </span>
            )}
