...
export function ServiceCardHome({ title, description, index }: ServiceCardProps) {
    ...
    return (
      <motion.div
        ...
        className="relative p-6 rounded-[20px] border border-white bg-transparent min-h-[370px] flex flex-col justify-between 
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-[24px] sm:text-[28px] font-bold text-white">{title}</h3>
          </div>
          <p className="text-[16px] sm:text-[18px] mb-4 text-white">{description}</p>
        </div>
