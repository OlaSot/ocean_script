  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] my-[40px]">
      {solutions.map((solution, index) => (
        <motion.div
          key={index}
          className={`group p-6 rounded-[20px] border border-white transition-all duration-500 ease-in-out flex flex-col justify-between min-h-[180px] md:min-h-[250px]
        ...
        >
          <div>
            <h3 className="text-xl font-bold text-white group-hover:text-black">
              {solution.title}
            </h3>
            <p className="text-base text-white group-hover:text-black mt-2">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 ">
              <span className="text-white font-semibold group-hover:text-black transition-colors duration-300">
                from
              </span>
